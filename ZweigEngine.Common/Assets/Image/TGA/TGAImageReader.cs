...
using ZweigEngine.Common.Assets.Image.TGA.Constants;
using ZweigEngine.Common.Assets.Image.TGA.Structures;
using ZweigEngine.Common.Utility;

namespace ZweigEngine.Common.Assets.Image.TGA;

internal sealed class TGAImageReader : IImageReader
{
